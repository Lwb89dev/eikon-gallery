...
/** The backup in Settings: which server, how to reach it, what to send and when, and how far it has got. Nothing leaves the phone until the switch is turned on. */
@Composable
